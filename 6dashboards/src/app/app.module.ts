...
import { ExpressgriddragdropComponent } from './expressgriddragdrop/expressgriddragdrop.component';
...
const appRoutes: Routes = [
  ...
  { path: "expressDrag", component: ExpressDragDropComponent },
  { path: "expressGrid", component: ExpressgriddragdropComponent },
  { path: "kanban", component: KanbanComponent },
  { path: "", redirectTo: "/kanban", pathMatch: "full" }
];
@NgModule({
  declarations: [AppComponent, WidgetDataComponent, WidgetFormatComponent, WidgetGridsterComponent, ExpressDragDropComponent, ExpressgriddragdropComponent, KanbanComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
