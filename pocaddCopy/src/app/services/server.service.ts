...
public createWidget(widget: {id: number, amount: number, clientId: number, userId: number, description: string}){
...
public updateWidget(widget: {id: number, amount: number, clientId: number, userId: number, description: string}){
